...
// Vendored from github.com/rakyll/portmidi. The cgo link/compile directives
// live in portmidi.go (this file only needs the C declarations).
package portmidi
...
// Read reads from the input stream, the max number events to be read are
// determined by max.
